...
In the model management page, choose the AI Library button in the menu and in the drop-down menu, pick "Public Models" to see all the publicly available models. You will see yolox in the list and you can create a copy of it by selecting the "create model" option as presented here:
